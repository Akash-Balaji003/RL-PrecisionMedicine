...
df = pd.read_csv("model/synthetic_multimodal_patient_dataset.csv")
...
torch.save(cf_encoder.state_dict(), "model/saved_models/cf_encoder.pth")
torch.save(cf_model.state_dict(), "model/saved_models/cf_qnetwork.pth")

import pickle
with open("model/saved_models/label_encoders.pkl", "wb") as f:
